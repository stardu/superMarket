    ...
    return (
      <Layout>
        ...
        <Layout>
          ...
          <Navigation
            name_a={this.state.showName_a}
            name_b={this.state.showName_b}
          />
          <Content
            style={{
              marginLeft: 16,
          ...
          >
            <Switch>
              ...
              <Route
                path="/home/orderList"
                exact
                component={asyncComponent(() => import("../order/orderList"))}
              ></Route>
              <Route
                path="/home/addOrder"
                exact
                render={() => <AddOrder> </AddOrder>}
              ></Route>
              <Route
                path="/home/goodsList"
                exact
                render={() => <GoodsList> </GoodsList>}
              ></Route>
              <Route
                path="/home/addGoods"
                exact
                render={() => <AddGoods> </AddGoods>}
              ></Route>
              <Route
                path="/home/editGoods"
                exact
                render={() => <EditGoods {...this.props}> </EditGoods>}
              ></Route>
            </Switch>
          </Content>
        </Layout>
