...
const urlDev: string = "/xx";
/* const urlPro = "http://aipig.api.limei.com";
const urlUat = "http://aipig-uat.api.limei.com";
const urlTest = "http://aipig-test.api.limei.com"; */
let urlOfWeb = window.location.host;

if (urlOfWeb == "localhost:8083") {
    axios.defaults.baseURL = urlDev;
} /* else if (urlOfWeb == "aipig-test.limei.com") {
    axios.defaults.baseURL = urlTest;
} else if (urlOfWeb == "aipig-uat.limei.com") {
    axios.defaults.baseURL = urlUat;
} else if (urlOfWeb == "aipig.limei.com") {
